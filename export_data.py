...
root = Tk()
root.title('Inventory Management System | Export Data')
root.state('zoomed')
...
l1 = Label(root, text='Export Data',foreground = 'white',background='cyan4',activebackground = 'Light Blue' ,font=('Times New Roman', 45, 'bold'))
l1.place(x = 550,y = 20)
...
search_frame = LabelFrame(root, text = 'Search Export Data',font = ('goudy old type',12, 'bold'))
